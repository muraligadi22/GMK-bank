...
<html lang="en">
  ...
  <body>
    <div class="containe">
      ...
      <div class="navigatio">
          <div class="logo">
              <img src="./img/icon_bank.png" alt="logo" style="height: 50px;">
              GMK<span class="logo-hlt"></span> Bank
          </div>
          <nav>
              <ul>
                  <li>
      ...
      <form action="select.php" method="POST" style="text-align:center">
        <label class="choose" style="color: lightgreen; font-size: 2rem; font-weight: 500;">Customer Name &#40;Sender&#41;: </label>
        <select id="cus" name="cus" style="width: 20%; height: 28px; margin-left: 8px;">
    ...
    <!----------Footer---------->
    <footer id="footer">
      <p>&copy; Copyright 2021 <span class="footer_logo">GMK Bank</span></p>
      <div class="social-icon">
              <a href="https://www.linkedin.com/in/gadi-murali-krishna-14b93422b"><i class="fab fa-linkedin-in"></i></a>
              <a href="mailto: muraligadi2001@gmail.com"><i class="fas fa-envelope"></i></i></a>
